    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (c) {
                ...
                c.ieW && (d = c.ieW);
                var g = e.offsetHeight, e = e.style, h = this.chartDiv.style, k = c.position;
            ...
            if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
                var b = this.animations[a], c = d.updateRate * b.time, e = b.frame + 1, f = b.obj, g = b.attribute;
                if (e <= c) {
                    b.frame++;
...
(function () {
    ...
    d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            this.sdy = this.sdx = 0;
            if (!isNaN(a)) {
                var e = this.follow, f = c.container, g = this.set;
                d.remove(g);
                this.removeDiv();
                g = f.set();
                g.node.style.pointerEvents = "none";
                ...
                if (this.show) {
                    ...
                    var q = this.horizontalPadding, y = this.verticalPadding, B = this.pointerWidth,
                        u = this.pointerOrientation, w = this.cornerRadius, v = c.fontFamily, A = this.fontSize;
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (g.translate(this.prevX, this.prevY, NaN, !0), g.animate({translate: x - f + "," + A}, b, "easeOutSine"), n && (C.left = this.prevTX + "px", C.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = x - f;
                    this.prevY = A;
                    this.prevTX = m;
                    this.prevTY = k
...
(function () {
    ...
    d.triangle = function (a, b, c, e, d, g, h, k) {
        ...
        void 0 === h && (h = "#000");
        void 0 === k && (k = 0);
        e = {fill: e, stroke: h, "fill-opacity": d, "stroke-width": g, "stroke-opacity": k};
        b /= 2;
        var l;
    ...
    d.wedge = function (a, b, c, e, f, g, h, k, l, m, n, p, r, t) {
        ...
        359.94 < u && (u = 359.94);
        f >= u && (f = u);
        var w = 1 / 180 * Math.PI, u = b + Math.sin(e * w) * k, v = c - Math.cos(e * w) * y,
            A = b + Math.sin(e * w) * g, C = c - Math.cos(e * w) * h, x = b + Math.sin((e + f) * w) * g,
            z = c - Math.cos((e + f) * w) * h, F = b + Math.sin((e + f) * w) * k, w = c - Math.cos((e + f) * w) * y,
        ...
        inherits: d.AmChart, construct: function (a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    var m = b.realHeight, n = b.realWidth, p = b.mapWidth, r = b.mapHeight;
            ...
            var f = this.realWidth, g = this.realHeight, h = this.mapSet.scale, k = this.zoomControl,
    ...
    d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            var f = c.buttonSize, g = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor,
                l = c.buttonFillAlpha, m = c.buttonBorderThickness, n = c.buttonBorderColor, p = c.buttonBorderAlpha,
                r = c.buttonCornerRadius, t = c.buttonRollOverColor, q = c.gridHeight, y = c.zoomFactor,
                B = c.minZoomLevel, u = c.maxZoomLevel, w = c.buttonIconAlpha, v = c.buttonIconColor,
                A = c.roundButtons, C = a.svgIcons, x = a.getX(c.left), z = a.getY(c.top);
